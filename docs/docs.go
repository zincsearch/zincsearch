    ...
    "paths": {
        ...
        "/api/account": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Current password plus new name and/or new password",
                        "name": "account",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "meta.Property": {
            ...
            "properties": {
                ...
                "dims": {
                    "description": "vector dimension, 0 accepts any",
                    "type": "integer"
                },
                "fields": {
                ...
                "type": {
                    "description": "text, keyword, date, numeric, boolean, geo_point, vector",
                    "type": "string"
                }
            }
        },
