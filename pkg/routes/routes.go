...
func SetRoutes(r *gin.Engine) {
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{config.Global.FrontendScheme + "://" + config.Global.Hostname + ":" + config.Global.FrontendPort},
	...
	r.GET("/api/login/verify", AuthMiddleware("auth.ListUser"), auth.GetUser)
	r.GET("/api/login/refresh", JWTMiddleWare.RefreshHandler)
	r.POST("/api/logout", AuthMiddleware("auth.ListUser"), JWTMiddleWare.LogoutHandler)
